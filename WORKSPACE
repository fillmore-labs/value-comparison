...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_java/releases/download/8.10.0/rules_java-8.10.0.tar.gz",
)
...
maven_install(
    artifacts = [
        ...
        "org.checkerframework:checker-qual:3.49.0",
        "org.checkerframework:checker-util:3.49.0",
        "org.checkerframework:checker:3.49.0",
